...
Capture the major components, their responsibilities, interfaces between them, and design decisions following the format rules in docs/constitutions/design.yaml.
