...
func main() {
	...
	fmt.Println(byteArrayToString(utsname.Machine[:]))
}
...
// parseArgs validates command-line arguments. arch accepts only --help and
...
func parseArgs(args []string) error {
	for _, arg := range args {
		...
		// R1.2: --help prints usage to stdout and exits 0.
		if arg == "--help" {
