...
// Differential tests for cmd/sha256sum against gsha256sum (GNU coreutils).
// Implements prd032-sha256sum AC1-AC6.
package main
...
// stderrBinaryNameNormalizer replaces "gsha256sum:" with "sha256sum:" so stderr
