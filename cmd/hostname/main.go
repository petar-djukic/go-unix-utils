...
// Package main implements cmd/hostname: print system hostname.
...
// R1.1: no arguments prints hostname with trailing newline.
...
func run(args []string) error {
	...
	// R1.1, R1.2: print the system hostname via gethostname(2).
