...
// Package main provides differential tests for cmd/hostname.
// Tests cover srd047-hostname R3.1, R3.2, R3.3.
package main
...
func TestDiff(t *testing.T) {
	...
	tests := []testutils.DiffTest{
		// R3.1/R3.2: default invocation with no arguments prints hostname.
		{
