...
// Tests for cmd/sha224sum implementing prd074-sha224sum R1.1-R1.4, R2.1-R2.3,
// R3.1-R3.2, R4.1-R4.3.
package main
...
func TestDiff(t *testing.T) {
	...
	tests := []testutils.DiffTest{
		...
		// R3.2: --tag outputs BSD format "SHA224 (FILENAME) = HASH".
		{
			Name:     "tag_format",
		...
		// R1.2: empty stdin produces the SHA-224 of empty input.
		{
			Name:     "empty_stdin",
			Args:     []string{},
			Stdin:    []byte{},
