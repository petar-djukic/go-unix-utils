...
// cmd/base32 encodes and decodes Base32 data per RFC 4648.
//
// Implements prd079-base32: R1.1 (encode stdin/file), R1.2 (default wrap at 76),
...
// runEncode encodes input to Base32 with wrap control.
...
// matching GNU coreutils base32 -w 0 behavior.
...
// runDecode decodes Base32 input with optional garbage skipping.
