...
// Package main provides differential tests for cmd/users.
// Tests cover srd096-users R2.1-R2.3.
package main
...
// R2.3: replaces binary paths with "PROG" so error message structure
...
func TestDiff(t *testing.T) {
	...
	tests := []testutils.DiffTest{
		// R2.1: default invocation prints sorted space-separated
		// logged-in usernames, matching gusers output.
		{
			Name: "default_no_args",
			Args: []string{},
		},

		// R2.3: --help flag exits 0.
		{
			Name:      "help_flag",
			Args:      []string{"--help"},
		...
		// R2.2/R2.3: unknown flag produces error and exit 1.
		{
			Name:      "unknown_flag",
			Args:      []string{"--bogus"},
			ExitCode:  1,
