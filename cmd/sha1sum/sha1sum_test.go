...
// R4.1-R4.3: core SHA-1 digest computation, standard GNU output format,
// stdin reading, multiple file processing with error handling,
// --check verification mode with --strict and --warn modifiers,
